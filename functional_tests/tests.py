...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # Francis get his own URL unique URL.
    ...
    def test_can_start_a_list_for_one_user(self):
        # Bobby has heard about a cool new online to-do app.
        ...
        # Bobby hobby is tying fly-fishing lures
        inputbox.send_keys('Buy peacock feathers')

        # when she hits enter, the page updates, and now the
        # page lists '1: Buy peacock feathers' as an item in
        # a to-do list table.
        inputbox.send_keys(Keys.ENTER)
        time.sleep(1)
        self.wait_for_row_in_list_table('1: Buy peacock feathers')
        ...
        # She enters 'Use peacock feathers to make a fly' (Bobby is very
        # methodical)
        inputbox = self.browser.find_element_by_id('id_new_item')
